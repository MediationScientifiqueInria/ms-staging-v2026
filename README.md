...
```
cd existing_repo
git remote add origin https://gitlab.inria.fr/mediation-scientifique/mediation-inria.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.inria.fr/mediation-scientifique/mediation-inria/-/settings/integrations)
